          ...
          <div className="h-[600px] bg-gray-800 pattern py-20 lg:py-32">
            <div className="max-w-6xl px-6 mx-auto text-center">
              ...
              <p className="text-gray-200 mt-10 font-thin text-md lg:text-lg">
                ...
                personnels pour mettre en pratique ce que je découvrais durant mes recherches, avant de finalement me
                rendre compte que je ne me lassais pas de coder. C'était devenu ma passion.
                <br />
                Je savais déjà ce que je voulais faire après mon DUT. C'est donc pourquoi j'ai décidé de continuer dans
                une formation où je pourrais vraiment me spécialiser dans le développement web. Je souhaite devenir
          ...
          <div className="w-full h-[550px] bg-white relative py-20 flex justify-center">
            <div className="w-4/5 h-auto absolute lg:-mt-52 flex flex-col lg:flex-row justify-center bg-white rounded-lg shadow-xl text-center">
              <div className="w-[400px] flex-grow flex-shrink py-[60px] lg:border-r border-[#E6ECF8]">
                ...
                <p className="font-thin">Node, Typescript, JS, HTML, CSS, PHP</p>
              ...
              <div className="w-[400px] flex-grow flex-shrink py-[60px] lg:border-r border-[#E6ECF8]">
                ...
                <div className="font-semibold text-lg mb-4 mt-8">Les languages utilisés</div>
                <p className="font-thin">Node, Typescript, JS, Bash</p>
                <div className="font-semibold text-lg mb-4 mt-8">Base de données</div>
                <ul className="list-none font-thin">
                  <li>PostgreSQL</li>
                  <li>MySQL</li>
                  <li>PrismaDB</li>
